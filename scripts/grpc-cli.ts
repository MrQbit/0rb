...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/orb2.proto')
...
const orb2Proto = protoDescriptor.orb2.v1
...
async function main() {
  ...
  const client = new orb2Proto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mORB2 gRPC CLI\x1b[0m')
