...
const PROTO_PATH = path.resolve(import.meta.dirname, '../src/proto/rak00n.proto')
...
const rak00nProto = protoDescriptor.rak00n.v1
...
async function main() {
  ...
  const client = new rak00nProto.AgentService(
    `${host}:${port}`,
  ...
  console.log('\x1b[32mRAK00N gRPC CLI\x1b[0m')
