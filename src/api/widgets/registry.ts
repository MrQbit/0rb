...
export const WIDGET_CATALOG: WidgetDef[] = [
  ...
  { id: 'media-remote', name: 'Speakers', desc: 'Speaker & receiver remote (play, volume, artwork).', category: 'Home', setup: 'none', icon: '🔊', envKeys: ['ORB2_HA_TOKEN'] },
  { id: 'tv', name: 'TV remote', desc: 'Power, inputs, volume and transport for your TV.', category: 'Home', setup: 'none', icon: '📺', envKeys: ['ORB2_HA_TOKEN'] },
  ...
  { id: 'house-map', name: 'House map', desc: 'The digital twin — rooms, devices in place, live activity.', category: 'Home', setup: 'none', icon: '🗺️', envKeys: [] },
  ...
  { id: 'receipts', name: 'Receipts', desc: 'Everything Orb did — who asked, what changed, one-tap undo.', category: 'Home', setup: 'none', icon: '🧾' },
