...
export const CATALOG: Record<string, CatalogEntry> = {
  ...
  media: { fields: { entity_id: S, name: S, kind: S, area: S, state: S, media_title: S, app: S, volume: N, artwork: S }, attention: 'glance', refresh: 'live', hint: 'speaker/receiver remote' },
  tv: { fields: { entity_id: S, name: S, area: S, state: S, source: S, sources: A, app: S, volume: N, artwork: S }, attention: 'glance', refresh: 'live', hint: 'TV remote: power, inputs, volume, transport' },
  spotify: { fields: { connected: B, now: O, devices: A, playlists: A }, attention: 'glance', refresh: 'live', hint: 'Spotify player: now playing, devices, playlists, search' },
  ...
  'house-map': { fields: { floors: A, rooms: A }, attention: 'glance', refresh: 'live', hint: 'Digital twin: floors/rooms map, device counts, live room activity' },
